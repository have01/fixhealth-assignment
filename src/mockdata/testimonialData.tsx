const data = [
  {
    problem: "Fixed back pain from home",
    username: "Aaron Moitra",
    userImage: "",
    reviewText:
      "Good initiative. The doctors are responsive and provide you a brief consultation It Good initiative. The doctors are responsive and provide you a brief consultation It serves only what we need.find good specialists like gynecologists, dermatologists, and dentists. Not anymore! No waste of time anymore serves only what we need.find good specialists like gynecologists, dermatologists, and dentists.Not anymore! No waste of time anymore",
    reviewLink: "",
    reviewStar: 4,
    company: "Google",
    image:
  ...
  {
    problem: "Sitting back pain ease",
    username: "Venu Gowda",
    userImage: "",
    reviewText:
      "It serves only what we need. Very simple and more than sufficient for getting a solution for any medical queries.find good specialists like gynecologists, dermatologists, and dentists. Not anymore! No waste of time anymore, ",
    reviewLink: "",
    reviewStar: 3,
    company: "Adobe",
  },
  {
    problem: "Injury of 12 years is fixed",
    username: "Abhiram Gurijala",
    userImage: "",
    reviewText:
      "All your health needs in one app. Online consultation for minor health issues, medicines etc. And these are not just some paid news, but genuine articles on tips and tricks that you can actually apply to live a healthy life",
    reviewLink: "",
    reviewStar: 5,
    company: "Microsoft",
  },
  {
    problem: "Effective Post Surgery Rehab",
    username: "Anurag Bansal",
    userImage: "",
    reviewText:
      "It has excellent doctors, excellent user interface, very user-friendly, has options for free consultations also, even the paid options have excellent worth. On top of everything, it also gives you tips to live a healthy life for free.",
    reviewLink: "",
    reviewStar: 4,
    company: "HDFC",
  },
  {
    problem: "Surgery-free neck pain relief",
  ...
  },
  {
    ...
    userImage: "",
    reviewText:
      "Very helpful. Far easier than doing the same things on the computer. Allows quick and easy search with speedy booking. Even maintains history of doctors visited. Thanks Practo for making it simple.",
    reviewLink: "",
    reviewStar: 5,
    company: "SpaceX",
  },
  ...
  },
  {
    ...
    userImage: "",
    reviewText:
      "Boon for patients. God bless who made this app. Feedback- Practo has doctors for common diseases or complications. It should focus on those complications which are uncommon because it is hard to find a suitable doctor in some cases like Varicocele, Esinophill count increase",
    reviewLink: "",
    reviewStar: 5,
    company: "Levis",
  },
  ...
  },
  {
    ...
    userImage: "",
    reviewText:
      "I had severe pain in the chest as well as blood in cough. She quickly diagnosed my disease as pulmonary embolism and I was admitted to ICU. Now it's all fine. If I would have gotten late then I wouldn't be writing this. Thanks Practo!",
    reviewLink: "",
    reviewStar: 5,
    company: "Mindtree",
  },
